...
COLOR_MAP = {
    ...
    "大日本帝國": "#ff9999",  # 粉紅色 💗
    "蘇維埃社會主義共和國聯邦（蘇聯）": "#cc0000",      # 紅色 🔴
    "中華蘇維埃反國抗日革命軍": "#e67e22",  # 深橘色 🥮 (包圍中華民國，開局與日本宿敵)
...
if not st.session_state.game_started:
    ...
    *   **🔵 中華民國**：【四億同胞】擁有全場最高 **1億可用人力** 且戰損減半！但開局四周被「中華蘇維埃反國抗日革命軍」色塊包圍，發育腳步需要精打細算！
...
if current_player in st.session_state.dead_players:
    ...
    if current_player == "中華民國":
        st.info("💡 【核心政治限制激活】：你擁有 1 億可用人力且戰損減半！開局四周被中華蘇維埃反國抗日革命軍包圍。前5回合無法精準突擊，請利用這段時間快速盲擴張累積經濟！")
...
with tab_map:
    ...
    st.markdown("---")
    st.metric("🥮 中華蘇維埃反國抗日革命軍（地方割據）", f"{counts_current['中華蘇維埃反國抗日革命軍']} 格")

...
COLOR_MAP = {
    ...
    "中華蘇維埃反國抗日革命軍": "#990000",  # 鐵血深紅 🩸 (包圍中華民國，開局與日本宿敵)
...
if not st.session_state.game_started:
    ...
    *   **🔵 中華民國**：【四億同胞】擁有全場最高 **1億可用人力** 且戰損減半！但開局四周被「中華蘇維埃反國抗日革命軍」鐵血深紅色塊包圍，發育腳步需要精打細算！
...
with tab_map:
    ...
    st.markdown("---")
    st.metric("🥮 中中華蘇維埃反國抗日革命軍（地方割據）", f"{counts_current['中華蘇維埃反國抗日革命軍']} 格")
